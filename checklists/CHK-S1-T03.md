<!--
Source unique de la checklist vivante CHK-S1-T03 (racine, architecture Option 3).
Incluse dans docs/checklists/CHK-S1-T03.md via pymdownx.snippets.
...
3 sorties confirmées (REL-007 / #71) : `SET-04`, `SET-05`, `SET-06`.

| Repère | Usage | Raccord, Ø, état | Photo | État |
|---|---|---|---|---|
| S1-T03-SET-04 | SET | À relever | ☐ | À relever |
...
Première passe : vue générale, photographier les 3 sorties d'eau, repérer et photographier les regards, photographier l'ensemble d'arrosage.
