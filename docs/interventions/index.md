...
- panne récurrente ;
- changement de pièce important ;
- modification d'un standard ;
- observation terrain structurante ;
- intervention transmise à un autre service.

## Issue template

- [Créer une issue intervention](https://github.com/Simokes/tennismaintenance/issues/new?template=intervention.md)
